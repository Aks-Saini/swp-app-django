...
class VisualizePackagesView(APIView):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            packages = Package.objects.filter(destination=truck.destination, status="inventory")
            ...
            truck_data = {
                ...
                "axle_group_weight_ratings": [
                    int(x) for x in truck.axle_group_weight_ratings
            ...
            data_to_send = {"truck": truck_data, "boxes": packages_data}
...
class CreateApprovalAPIView(APIView):
    def post(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"message": "Approval created successfully", "approval": serializer.data},
